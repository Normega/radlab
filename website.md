...
`api/` functions (first added 2026-07-24): `api/health.js` (deploy check that functions coexist with the SPA rewrite) and `api/ingest.js` (§29a; `maxDuration: 300` set in both the file and `vercel.json`).
