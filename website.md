...
| `/profile` | `ProfilePage` | Protected — **narrowed 2026-07-30** (§12b) to identity, account facts (moved up from the Dashboard's deleted `// Account` block), points, unlock tracker, sessions completed |
