...
- [x] Mode-comparison API test — expanded to 4 papers incl. an OCR'd 1916 scan and a figure-bearing modern paper; parity throughout, native ~45% dearer; numbers recorded in `ingest-budget-estimate.md` (2026-07-24). [ ] Pick default mode (native provisionally recommended) + purge dual-mode test jobs before production
