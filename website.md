...
## 29b. Come, See prototype sketchbook (`public/prototypes/`, 2026-08-02→03)

Five self-contained prototype experiences for the Come, See sense-foraging platform — the five receptive dynamics from the design compendium (`I:\Shared drives\ComeSee\come-see-design-compendium_Aug1_2026.md`, §4) that had never been built, each breaking one link of the task-mode verb chain see → want → act → get. Built, agent-playtested, and merged in a single day (2026-08-02). Live at `/prototypes/` (index) as **inert static files** — plain HTML+canvas, no React, no Supabase, no auth, zero app-bundle impact.
