-- get_session_by_token: expose studies.assignment_slots to SessionEntry so the
-- client knows which condition slots to draw before starting the step flow.
-- Only change from the live definition: 'assignment_slots' added to the study
-- object in the return payload.
