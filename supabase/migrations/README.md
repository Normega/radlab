...
| `20260714_ripple_reminders.sql` | **not yet applied** — adds `ripples.reminder_enabled`, `ripples.reminder_time`, `ripples.last_reminder_sent_on`; creates `ripple_unsubscribe_tokens` table; includes commented pg_cron setup SQL for `ripple_reminder` Edge Function |
