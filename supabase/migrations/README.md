...
| `20260714_ripple_settings.sql` | **not yet applied** — adds `check_in_enabled boolean NOT NULL DEFAULT true` to `ripples`; apply in Supabase SQL editor before using `/ripple/settings` disable toggle |
