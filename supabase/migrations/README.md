...
| `20260715_zerin_screener.sql` | history: `20260715_zerin_screener`; live: `screeners` row `langerian-mindfulness-v1` (single-instrument PHQ-8 range gate 5-9, U of T + PSYC100 phase-1 gate + distress safety item). Applied via MCP 2026-07-15; verified 8 phase-1 items, phase2 scoring mode 'range', 1 phase-2 questionnaire. Consumed by the generalized `ScreenerPage`/`screenerUtils.evaluateScreenerPhase2` (Liliana's `emotion-regulation-v1` path proven byte-identical via a 56-assertion standalone test). |
