...
const S = {
  ...
  varPill:   { fontFamily: '"Space Mono",monospace', fontSize: 12, background: 'var(--bgp)', border: '1px solid var(--pkb)', borderRadius: 6, padding: '3px 8px', color: 'var(--pkd)', cursor: 'pointer' },
