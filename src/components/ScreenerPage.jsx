...
const S = {
  ...
  topBadge:     { fontSize: 12, fontFamily: '"Space Mono", monospace', fontWeight: 700, color: 'var(--tx2)', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: 6 },
  topBadgeDot:  { display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: 'var(--pk)' },
  stepIndicator:{ fontFamily: '"Space Mono", monospace', fontSize: 12, color: 'var(--tx2)', fontWeight: 600 },
  ...
  pageSubtitle: { fontFamily: '"DM Sans", system-ui, sans-serif', fontSize: 14, color: 'var(--tx2)', marginTop: 3 },
  scrollArea:   { flex: 1, overflowY: 'auto' },
  content:      { padding: 24 },
  partLabel:    { fontSize: 14, fontWeight: 600, color: 'var(--tx, #1c1c1e)', padding: '10px 14px', background: 'var(--bgp)', borderLeft: `3px solid ${GREEN}`, borderRadius: '0 6px 6px 0', marginBottom: 16 },
  ...
  stepNum:      { width: 24, height: 24, borderRadius: '50%', background: 'var(--bgp)', fontSize: 12, fontFamily: '"Space Mono", monospace', fontWeight: 700, color: 'var(--tx2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1 },
  stepText:     { fontSize: 14, lineHeight: 1.6, color: 'var(--tx)' },
  infoBox:      { background: 'var(--bg)', border: '1px solid var(--bds)', borderRadius: 10, padding: '14px 16px', marginBottom: 16, fontSize: 14, lineHeight: 1.7, color: 'var(--tx2)' },
  ...
  eligText:     { fontSize: 14, lineHeight: 1.55, color: 'var(--tx)', flex: 1 },
  eligBtns:     { display: 'flex', gap: 6, flexShrink: 0, marginLeft: 'auto', paddingLeft: 10 },
  eligBtn:      { width: 36, height: 28, borderRadius: 6, border: '1.5px solid var(--bds)', background: 'var(--bgp)', fontSize: 12, fontFamily: '"DM Sans", system-ui, sans-serif', fontWeight: 600, cursor: 'pointer', transition: 'all 0.12s' },
  ...
  statusBanner: { borderRadius: 10, padding: '14px 16px', marginTop: 12, fontSize: 14, lineHeight: 1.6 },
