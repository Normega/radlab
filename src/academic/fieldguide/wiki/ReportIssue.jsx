...
const S = {
  ...
  kindBtn: { fontSize: 13, padding: '7px 14px', borderRadius: 18, border: '1px solid var(--bd)', background: 'var(--bgc)', color: 'var(--tx2)', cursor: 'pointer' },
  ...
  select: { display: 'block', fontSize: 13, padding: '7px 9px', borderRadius: 8, border: '1px solid var(--bd)', background: 'var(--bg)', color: 'var(--tx)', marginBottom: 8, maxWidth: '100%' },
  ...
  mineBody: { fontSize: 13, color: 'var(--tx2)', lineHeight: 1.45 },
