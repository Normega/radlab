...
const S = {
  ...
  emptyText: { fontFamily: SERIF, fontSize: 28, color: 'var(--tx)', margin: '0 0 8px' },
  ...
  dialogTitle: { fontFamily: SERIF, fontSize: 28, fontWeight: 400, color: 'var(--tx)', margin: '0 0 12px' },
