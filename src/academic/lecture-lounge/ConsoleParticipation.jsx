...
const S = {
  ...
  exportBtn: { padding: '8px 16px', borderRadius: 8, border: '1px solid var(--bds)', background: 'var(--bgc)', color: 'var(--pkd)', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
  tableWrap: { overflowX: 'auto', borderRadius: 10, border: '1px solid var(--bd)', background: 'var(--bgc)' },
  table: { width: '100%', borderCollapse: 'collapse' },
  th: { fontFamily: MONO, fontSize: 12, color: 'var(--tx3)', textAlign: 'center', padding: '10px 14px', borderBottom: '1px solid var(--bd)', whiteSpace: 'nowrap' },
  thStudent: { fontFamily: MONO, fontSize: 12, color: 'var(--tx3)', textAlign: 'left', padding: '10px 14px', borderBottom: '1px solid var(--bd)', textTransform: 'uppercase', letterSpacing: '0.06em' },
  tr: { borderBottom: '1px solid var(--bd)' },
  td: { padding: '10px 14px', textAlign: 'center', fontSize: 14, color: 'var(--tx)', fontFamily: MONO },
  tdStudent: { padding: '10px 14px', fontSize: 14, color: 'var(--tx)', whiteSpace: 'nowrap' },
  email: { fontFamily: '"DM Sans",system-ui,sans-serif' },
  unverifiedBadge: { marginLeft: 8, fontFamily: MONO, fontSize: 12, color: '#b8760f', background: '#fdf2e5', padding: '2px 6px', borderRadius: 6 },
  zero: { color: 'var(--tx3)' },
}
