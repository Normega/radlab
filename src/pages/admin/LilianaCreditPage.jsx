...
const S = {
  ...
  sub:        { fontSize: 14, color: 'var(--tx2)', margin: 0, maxWidth: 640, lineHeight: 1.6 },
  ...
  warnTag:    { marginLeft: 8, fontFamily: '"Space Mono",monospace', fontSize: 12, color: '#a15c00', background: '#fff6e5', border: '1px solid #f0d090', borderRadius: 6, padding: '1px 6px' },
