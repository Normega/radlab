...
const P = {
  ...
  panelTitle: { fontFamily: '"Space Mono",monospace', fontSize: 12, color: 'var(--pkd)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 2 },
...
const S = {
  ...
  lockedBadge: { fontFamily: '"Space Mono",monospace', fontSize: 12, color: 'var(--gy)', background: '#f5f5f5', borderRadius: 6, padding: '3px 8px' },
  errBadge:    { fontFamily: '"Space Mono",monospace', fontSize: 12, color: '#e04', background: '#fff0f0', border: '1px solid #fcc', borderRadius: 6, padding: '3px 8px' },
