...
const S = {
  ...
  chevron:      { fontFamily: '"Space Mono",monospace', fontSize: 12, color: 'var(--tx3)', width: 12, flexShrink: 0 },
  ...
  srcChip:   { marginLeft: 8, fontFamily: '"Space Mono",monospace', fontSize: 12, background: 'var(--pkb)', color: 'var(--pk)', borderRadius: 5, padding: '1px 6px', textTransform: 'uppercase' },
  optOutChip:{ marginLeft: 8, fontFamily: '"Space Mono",monospace', fontSize: 12, background: '#fef3e8', color: '#7d4f00', borderRadius: 5, padding: '1px 6px' },
