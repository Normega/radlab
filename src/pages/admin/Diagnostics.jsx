...
const S = {
  ...
  refresh:   { fontFamily: '"DM Sans",system-ui,sans-serif', fontSize: 14, fontWeight: 600, padding: '7px 14px', borderRadius: 8, border: '1px solid var(--bd)', background: '#fff', color: 'var(--tx2)', cursor: 'pointer' },
  muted:     { fontFamily: '"DM Sans",system-ui,sans-serif', fontSize: 14, color: 'var(--tx3)' },
  ...
  errBox:    { fontFamily: '"DM Sans",system-ui,sans-serif', fontSize: 14, color: '#a32020', background: '#fdeaea', border: '1px solid #f3c9c9', borderRadius: 8, padding: '10px 12px' },
