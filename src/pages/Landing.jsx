  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={S.hero} className="px-5 md:px-[52px] text-center">
        ...
        <div className="flex flex-col items-center" style={{ gap: 12, marginBottom: 22 }}>
...
const S = {
  ...
  nav: {
    ...
    borderBottom: '1px solid var(--pkbs)', /* visible divider in place of a band */ background: 'rgba(252,240,245,0.97)',
