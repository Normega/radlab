...
const S = {
  ...
  meta: {
    fontFamily: MONO, fontSize: 10, color: TX3, letterSpacing: 1,
  ...
  shrinkLine2: {
    fontFamily: MONO, fontSize: 11, color: '#c97800', letterSpacing: '0.14em',
    textTransform: 'uppercase', marginBottom: 8,
  },
  shrinkLine3: {
    fontFamily: MONO, fontSize: 11, color: 'rgba(212,184,150,0.5)',
