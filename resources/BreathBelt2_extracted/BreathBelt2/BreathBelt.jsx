      ...
      <Layout title="Phase 3 — Detection thresholds">
        <StaircaseScreen
          ...
          onComplete={(trials, questState, convergence) => {
            ...
            window.__pendingQuestState = questState; // temp stash — consumed in POST_BASELINE_COMPLETE
          }}
        />
      </Layout>
    );
        ...
        <BaselineScreen
          ...
          onComplete={async (periodMs) => {
            ...
            await session.endSession({
              ...
              questState:          window.__pendingQuestState ?? null,
            ...
            delete window.__pendingQuestState;
