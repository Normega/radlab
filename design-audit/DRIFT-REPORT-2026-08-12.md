...
1. The Figma Style Tile's **Body** table lists 12 / 14 / 12 with roles copied verbatim from the Display table ("Section / results title", "Card / inline title"). The written spec says **16 / 14 / 12**, which is what the code and `/brand` follow. The Figma tile appears to be an authoring slip; worth a designer's confirmation.
