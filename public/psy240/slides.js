/* PSY240 lecture slideshow engine.
 *
 * Sibling copy of public/psy309/slides.js — identical behaviour, kept per-course
 * so a deck is self-contained (the whole point of these being static files).
 * Fix bugs in both.
 *
